...
public class DataValidator {
    ...
    public enum DataError { TeamNumberError, MatchNumberError, ScoutedByError, ScoreError, NONE }
    private static DataError dataError;

    public DataError CheckData(String teamNumber, String matchNumber, String scoutedBy, String score)
    {
