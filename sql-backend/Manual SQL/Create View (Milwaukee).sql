...
SUM(CASE WHEN(EndGameSuccess='1') THEN 1 ELSE 0 END) AS NumClimb1,
SUM(CASE WHEN(EndGameSuccess='2') THEN 1 ELSE 0 END) AS NumClimb2,
SUM(CASE WHEN(EndGameSuccess='3') THEN 1 ELSE 0 END) AS NumClimb3,
SUM(CASE WHEN(EndGameSuccess='4') THEN 1 ELSE 0 END) AS NumClimb4,
SUM(DefensePlays) AS TotalDefensivePlays,
MAX(DefensePlays) AS MaxDefensivePlays,
SUM(CASE WHEN(WinLossTie='W') THEN 1 ELSE 0 END) AS NumWins,
SUM(CASE WHEN(WinLossTie='L') THEN 1 ELSE 0 END) AS NumLosses,
SUM(CASE WHEN(WinLossTie='T') THEN 1 ELSE 0 END) AS NumTies,
